    ...
    <div className={styles.pageWrapper}>
        ...
        <div className={styles.heroBannerContent}>
          <div className={styles.heroTextSide}>
            ...
            <h1 className={styles.heroTitle}>
              Challenge the<br/>status quo today
            </h1>
            <p className={styles.heroSubtitle}>
              Achieve remarkable things<br/>tomorrow
            </p>
          </div>
        </div>
        <div className={styles.heroImageSide}>
          <div className={styles.heroImageWrapper}>
            {/* The image goes here via CSS background or img tag */}
          </div>
      ...
      <section className={styles.mapSection}>
        <div className={styles.mapContainer}>
          <iframe 
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3022.1422937950147!2d-73.98731968459391!3d40.75889497932681!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89c25855c6480299%3A0x55194ec5a1ae072e!2sTimes+Square!5e0!3m2!1sen!2sus!4v1560413982901!5m2!1sen!2sus" 
            width="100%" 
            height="100%" 
            style={{ border: 0 }} 
            allowFullScreen="" 
